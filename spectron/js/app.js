            ...
            $(function() {
                ...
                var e = function() {
                        function e() {
                            ...
                            var l = "" + parseInt(100 * h)*0.5,
                                u = "MAX:" + parseInt(100 * c)*0.5,
                                f = i,
                                m = 50,
                                y = 50 +    window.SCORE_TOP_PADDING;
                            f.font = "30px Arial", f.textAlign = "left", f.fillText(u, m, y), f.font = "30px Arial", f.textAlign = "left", f.fillText(l, m+window.innerWidth*0.4, y), i.stroke()
                        }
                        window.parent.postMessage("ready", "*"), window.RECORDING_TIME = 60000*60;
                        var t = u;
    ...
    9: [function(e, t, n) {
        (function(n, i, r, s, o, a, h, l, u) {
            function f() {
                ...
                i.gain.value = 1, t.connect(e), e.connect(i), i.connect(context.destination), this.context = context, this.mix = t, this.filterGain = i, this.analyser = e, this.buffers = {}, c.loadTrackSrc(this.context, "bin/snd/earth.m4a", function(e) {
